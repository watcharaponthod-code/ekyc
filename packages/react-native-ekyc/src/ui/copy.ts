...
const th: Strings = {
  ...
  challenge: {
    ...
    moveCloser: 'ขยับหน้าเข้าใกล้กล้อง',
    moveFarther: 'ขยับหน้าออกห่างจากกล้อง',
  },
  challengePhase2: {
    ...
    openMouth: 'หุบปาก',
    smile: 'คลายยิ้ม',
    moveCloser: 'แล้วถอยกลับที่เดิม',
    moveFarther: 'แล้วขยับกลับที่เดิม',
  },
  holdOn: 'ค้างไว้',
...
const en: Strings = {
  ...
  challenge: {
    ...
    moveCloser: 'Move your face closer',
    moveFarther: 'Move your face farther away',
  },
  challengePhase2: {
    ...
    moveCloser: 'Now move back',
    moveFarther: 'Now come back',
  },
  holdOn: 'Hold steady',
  uploading: 'Checking…',
